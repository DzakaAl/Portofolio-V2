      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-center">
        ...
        <div className="lg:col-span-7 space-y-8">
          <div>
            <div className="flex items-center gap-3 mb-3">
              ...
              <span className="font-mono text-xs uppercase tracking-widest text-purple-400">BIOGRAPHY</span>
            </div>
          ...
          <div className="flex items-center gap-4 pt-2">
            ...
            <a
              ...
              target="_blank"
              rel="noreferrer"
              className="w-12 h-12 rounded-full glass-card flex items-center justify-center text-slate-300 hover:text-purple-400 hover:border-purple-500/50 hover:scale-110 transition-all"
              title="GitHub"
            >
            ...
            <a
              ...
              target="_blank"
              rel="noreferrer"
              className="w-12 h-12 rounded-full glass-card flex items-center justify-center text-slate-300 hover:text-cyan-400 hover:border-cyan-500/50 hover:scale-110 transition-all"
              title="LinkedIn"
            >
            ...
            <a
              ...
              target="_blank"
              rel="noreferrer"
              className="w-12 h-12 rounded-full glass-card flex items-center justify-center text-slate-300 hover:text-pink-400 hover:border-pink-500/50 hover:scale-110 transition-all"
              title="Dribbble"
            >
          ...
          <div className="grid grid-cols-2 sm:grid-cols-4 gap-4 pt-6 border-t border-white/10">
            {stats.map((stat, idx) => {
              ...
              return (
                <div key={idx} className="glass-card p-4 rounded-xl border border-white/5 hover:border-purple-500/30 transition-all">
        ...
        <div className="lg:col-span-5 flex justify-center">
          <div className="relative group max-w-md w-full">
            ...
            <div className="absolute -inset-1 bg-gradient-to-r from-purple-600 to-cyan-500 rounded-2xl blur-xl opacity-40 group-hover:opacity-75 transition duration-500" />

            {/* Main Portrait Frame */}
            <div className="relative rounded-2xl overflow-hidden glass-panel border border-white/15 p-2 bg-[#0c0e18]">
              <div className="relative aspect-[3/4] rounded-xl overflow-hidden">
                ...
                <div className="absolute bottom-4 left-4 right-4 p-4 glass-panel rounded-xl border border-white/10 flex items-center justify-between">
                  <div>
                    ...
                    <p className="text-xs text-purple-400 font-mono">CREATIVE DIRECTOR</p>
                  </div>
