  ...
  const renderLogoItem = useCallback(
    (item: LogoLoopItem, key: string) => {
      ...
      const content = isNodeItem ? (
        ...
        <img
          className={cx(
            'h-[var(--logoloop-logoHeight)] w-auto block object-contain filter grayscale invert opacity-70 hover:opacity-100 hover:grayscale-0',
            '[-webkit-user-drag:none] pointer-events-none transition-all duration-300',
...
const LogoLoopMemo = React.memo(LogoLoop);

LogoLoopMemo.displayName = 'LogoLoop';

export default LogoLoopMemo;
